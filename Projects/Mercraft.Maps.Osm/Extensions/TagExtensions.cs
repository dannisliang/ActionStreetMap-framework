...
namespace Mercraft.Maps.Osm.Extensions
{
    ...
    public static class TagExtensions
    {
        ...
        public static string GetAccessTag(this IList<KeyValuePair<string, string>> tags, IEnumerable<string> accessTagHierachy)
        {
            if (tags == null)
                return null;
        ...
        /// <returns></returns>
        public static bool TryGetMaxSpeed(this IList<KeyValuePair<string, string>> tags, out double result)
        {
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        public static bool TryGetMaxWeight(this IList<KeyValuePair<string, string>> tags, out double result)
        {
            result = double.MaxValue;
            string tagValue;
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        public static bool TryGetMaxAxleLoad(this IList<KeyValuePair<string, string>> tags, out double result)
        {
            result = double.MaxValue;
            string tagValue;
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        public static bool TryGetMaxHeight(this IList<KeyValuePair<string, string>> tags, out double result)
        {
            result = double.MaxValue;
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        public static bool TryGetMaxWidth(this IList<KeyValuePair<string, string>> tags, out double result)
        {
            result = double.MaxValue;
            string tagValue;
